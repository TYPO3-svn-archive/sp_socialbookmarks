<?php
	...
	if (TYPO3_MODE == 'BE') {
			// Wizard icon
		$GLOBALS['TBE_MODULES_EXT']['xMOD_db_new_content_el']['addElClasses']['tx_spsocialbookmarks_pi1_wizicon'] =
			t3lib_extMgm::extPath($_EXTKEY) . 'pi1/class.tx_spsocialbookmarks_pi1_wizicon.php';
